import {
  ...
  Button_default2,
  useButtonProps
} from "./chunk-JWRO27QI.js";
import {
  require_react_dom
} from "./chunk-MCEUSTYS.js";
import {
  Container_default
} from "./chunk-M2B7YLVD.js";
import {
  DEFAULT_BREAKPOINTS,
...
var DropdownContext = React43.createContext(null);
...
var SelectableContext = React46.createContext(null);
...
var NavContext = React47.createContext(null);
...
var TabContext = React82.createContext(null);
...
var NavItem = React83.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
...
var Nav = React84.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
...
var ListGroupItem = React85.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React86.forwardRef((props, ref) => {
  const {
    className,
...
var RTGTransition = React87.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose9(_ref, _excluded8);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime81.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime82.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime82.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime82.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react63.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime83.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime83.jsx)("div", Object.assign({}, dialogProps, {
    children: React89.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime83.jsx)(import_jsx_runtime84.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime85.jsxs)(import_jsx_runtime84.Fragment, {
...
var ModalBody = React90.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React91.createContext({
...
var ModalDialog = React92.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React93.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React94.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var ModalHeader = React95.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React96.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React97.forwardRef(({
  ...
  const renderBackdrop = (0, import_react65.useCallback)((backdropProps) => (0, import_jsx_runtime93.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React98.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React99.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React100.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React101.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React102.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React103.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React104.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React105.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime101.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React105.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React106.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React107.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React108.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react71.useCallback)((backdropProps) => (0, import_jsx_runtime104.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React109.forwardRef((props, ref) => {
...
var NavbarText = React110.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React111.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React112.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React113.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React114.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React115.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React117.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Tooltip = React118.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Overlay2 = React119.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime118.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React119.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React120.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime121.jsxs)(import_jsx_runtime120.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react78.cloneElement)(children, triggerProps), (0, import_jsx_runtime119.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React121.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React121.forwardRef(({
    children,
    ...props
...
var PlaceholderButton = React123.forwardRef((props, ref) => {
...
var Placeholder = React124.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React125.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React126.forwardRef(({
  ...
  return (0, import_jsx_runtime128.jsx)("div", {
    ...
    children: React126.Children.only(children)
  });
});
...
var Spinner = React128.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React129.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React131.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var TabContent = React134.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React135.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React138.forwardRef((props, ref) => (0, import_jsx_runtime142.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React139.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React140.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
...
var ToastBody = React141.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React143.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop7 = () => void 0;
var ToggleButton = React144.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React145.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
